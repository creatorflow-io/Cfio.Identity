...
using Cfio.IdentityServer.STS.Identity.ViewModels.Account;
...
namespace Cfio.IdentityServer.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                {
                    var authenticationHandlerProvider = HttpContext.RequestServices.GetRequiredService<IAuthenticationHandlerProvider>();
                    var handler = await authenticationHandlerProvider.GetHandlerAsync(HttpContext, idp);
